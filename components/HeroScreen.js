  ...
  return (
    ...
    <div id="large-header" className="bg-[url('/cargo3.png')] bg-cover min-h-screen relative">
            ...
            <div className="md:w-3/4 mr-4 relative z-10">
              <div className="p-4 md:p-8 text-white">
                ...
                <div className='ml-2 mt-12'>
                  <a href="https://docs.google.com/document/d/1k_5nYxz0cnjNdGEtiyfW04WNJvkxiJuL/edit" className="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl group">
        ...
        />
          ...
          <div className="absolute inset-x-0 bottom-0 h-96 bg-gradient-to-b from-transparent to-black"></div>
        </div>
